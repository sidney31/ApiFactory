...
$(document).ready(function ($) {
  ...
  const SERVICES_JSON = {
    'Информационные технологии': {
      'Управление сетями передачи данных': [
        ...
        'Управление оборудованием WAN, виртуальными частными сетями и демилитаризованной зоной',
        'Управление структурированной кабельной системой',
        'Управление сетевыми устройствами',
        'Управление межсетевыми экранами',
      ],
      'Управление серверным оборудованием': [
        'Поддержка операционных систем и базового ПО серверного оборудования',
        'Поддержка серверов',
        'Управление оборудованием хранения данных',
      ],
      'Системное администрирование': [
        'Управление службой единого каталога',
        'Управление базовыми сетевыми службами (DNS,DHCP,NTP)',
  ...
  let tab = new Tab(SERVICES_JSON, $('#serivces-tabs'))
